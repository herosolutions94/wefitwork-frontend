...
export default function Search({result}) {
    ...
    const [searchResult, setSearchResult] = useState({ professions: professions });
        ...
        <section className="banner_search_review">
            <div className="contain">
                <div className="cntnt">
                    ...
                    <form>
                        <input type="text" className="input" name="search_name" placeholder={"Entre Professional Name"} onChange={handleSearchByName}/>
                        ...
                        <div className="col" key={i}>
                            <div className="inner">
                                ...
                                <div className="btn_blk">
                                    <Link href={`/buyer-dashboard/leave-review/${encrypt_decrypt('encrypt', val?.mem_id)}`} className="site_btn color block">Leave Review</Link>
                                </div>
                            </div>
                        </div>
                        );
