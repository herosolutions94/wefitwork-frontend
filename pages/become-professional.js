    ...
    <>
      ...
      <main>
        <section
          ...
          style={{ background: cmsFileUrl(content?.image2) }}
        >
            ...
            <div className="flex">
              <div className="colL">
                ...
                <div className="btn_blk">
                  <Link
                    href={"#"}
                    onClick={handleRedirectProfession}
        ...
        <section className="choose_us_sec">
          <div className="contain">
            <Link
              href={content?.ribbon_button1_link}
              className="announcment_lbl"
            >
              <Image
                ...
                <div className="inner">
                  ...
                  <div className="btn_blk">
                    <Link
                      ...
                      className="site_btn color min_wid"
                    >
                      <Text string={content?.sec4_button1_text} />
                    </Link>
                  </div>
                </div>
              </div>
          ...
          <div className="contain">
            <div className="cntnt">
              ...
              <div className="btn_blk text-center">
                ...
                >
                  <Text string={content?.sec5_button1_text} />
                </Link>
              </div>
              <h6>
