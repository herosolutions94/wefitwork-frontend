    ...
    <>
              ...
              <div className="professiona_view_tile">
                ...
                wishlist !== undefined ? (
                      ...
                      <div className="col" key={i}>
                        <div className="action_buttons">
                          ...
                          <button
                            type="button"
                            className="share_btn"
                            onClick={() => handleOpenSharePopup(val?.mem_id)}
                          >
                  ...
                  <div className="alert alert-danger">
                    You haven't wishlisted any Professional
                  </div>
                )}
              </div>
            )}
      ...
      <PopupSmall isOpen={isSharePopup} onClose={handleCloseSharePopup}>
        <SocialShare
          ...
          url={`${baseURL}/search-result/${encrypt_decrypt("encrypt", proId)}`}
