            ...
            <ul className="frnds scrollbar">
              ...
              <li data-chat="person2">
                <div className="inner unread">
                  ...
                  <div className="time_msg_ago">10:20 pm</div>
                </div>
              </li>
              <li data-chat="person3">
                <div className="inner sms unread">
                  ...
                  <div className="time_msg_ago">9:00 pm</div>
                </div>
              </li>
            </ul>
          </div>
          <div className="chatBlk relative">
            ...
            <div className="chat scrollbar active" data-chat="person1">
              ...
              <div className="buble me">
                ...
                <div className="txt">
                  <div className="cntnt">
                    <p>I know you. You can do it. Good luck, Jennifer!</p>
                  </div>
                  <div className="time">10:00 Pm</div>
                </div>
              </div>
            ...
            <div className="write">
              <form className="relative">
                <div className="btm">
                  ...
                  ></textarea>
                  <button type="submit" className="site_btn icoBtn">
