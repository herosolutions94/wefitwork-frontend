    ...
    <>
        {
            ['jpg', 'jpeg', 'png', 'gif'].includes(extension) ?
                <a className="images_contain" href={cmsFileUrl(file, "msg_attachments")} target="_blank" download>
                    <div className="image">
                ...
                extension === 'doc' || extension === 'docx' ?
                    <a className="attachment_document flex" href={cmsFileUrl(file, "msg_attachments")} target="_blank" download>
                        <div className="icon">
